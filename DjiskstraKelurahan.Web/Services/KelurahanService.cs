...
public class KelurahanService : IKelurahanService
{
    ...
    [
        ...
        new Kelurahan { Nama = "Naioni", Koordinat = new PointF()},
        new Kelurahan { Nama = "Fatukoa", Koordinat = new PointF()},
        new Kelurahan { Nama = "Sikumana", Koordinat = new PointF()},
        new Kelurahan { Nama = "Bello", Koordinat = new PointF()},
        new Kelurahan { Nama = "Oepura", Koordinat = new PointF()},
        new Kelurahan { Nama = "Mantasi", Koordinat = new PointF()},
        new Kelurahan { Nama = "Fatufeto", Koordinat = new PointF()},
        new Kelurahan { Nama = "Nunhila", Koordinat = new PointF()},
        new Kelurahan { Nama = "Airmata", Koordinat = new PointF()},
        new Kelurahan { Nama = "Lai Lai Bisi Kopan", Koordinat = new PointF()},
        new Kelurahan { Nama = "Fontein", Koordinat = new PointF()},
        new Kelurahan { Nama = "Kolhua", Koordinat = new PointF()},
        new Kelurahan { Nama = "Maulafa", Koordinat = new PointF()},
        new Kelurahan { Nama = "Naimata", Koordinat = new PointF()},
        new Kelurahan { Nama = "Solor", Koordinat = new PointF()},
        new Kelurahan { Nama = "Tode Kisar", Koordinat = new PointF()},
        new Kelurahan { Nama = "Bonipoi", Koordinat = new PointF()},
        new Kelurahan { Nama = "Merdeka", Koordinat = new PointF()},
        new Kelurahan { Nama = "Oeba", Koordinat = new PointF()},
        new Kelurahan { Nama = "Fatubesi", Koordinat = new PointF()},
        new Kelurahan { Nama = "Nefonaek", Koordinat = new PointF()},
    ];
